...
class TuesmonClient(BaseClient):
    """ A Tuesmon Api Client.

    >>> from tuesmon_ncurses.api.client import *
    >>> api = TuesmonClient("http://localhost:8000")
